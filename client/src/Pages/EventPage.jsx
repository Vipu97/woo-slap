...
const EventPage = () => {
  ...
  return (
    <div className="px-4 sm:px-8">
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-5 gap-y-2">
        ...
        <div className="flex gap-2 text-[15px] items-center font-semibold overflow-hidden">
          ...
          <input
            ...
            value={`http:localhost:5173/${code}`}
            readOnly
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            onClick={() => clipBoard.writeText(`http:localhost:5173/${code}`)}
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      {event.responses && (
        <div className="mt-5 bg-[#ecf0f7] py-3 px-5 rounded-2xl flex flex-col">
          ...
          <div className="ml-auto mt-4 flex gap-3">
            <button
              className="bg-white py-2 px-2 xs:px-5 rounded-3xl font-black hover:bg-[#f2f5f7] hover:scale-105"
              onClick={handleResetButton}
            >
              Reset Event
            </button>
            <Link
              className="bg-blue py-2 px-2 xs:px-5 rounded-3xl
           text-white font-black hover:scale-105"
      ...
      <QuestionsModal eventId={event._id} code={code} />
      <QuestionsList
        questions={questions}
        code={code}
