    ...
    try{
      ...
      if(err.response.data.code === 11000){
        toast({
          ...
          description:"Try to Login with the same email", 
          status: "info", 
      })}
      else
        console.log("Error in backened " + err.message);
    }
  };
  return (
    <div>
      ...
      <div className="flex flex-col gap-x-8 lg:flex-row">
        ...
        >
          <form className="flex flex-col justify-center gap-1 items-center mt-12" onSubmit={registerUser}>
          ...
          py-1.5 px-3 pl-8 mt-4 w-[300px]"
            ...
            <AuthForm text={"Sign up"} email={email} setEmail={setEmail} password={password} setPassword={setPassword} />
          </form>
        </div>
      </div>
    </div>
